...
<table class="table tabel-striped">
	...
	<tbody> 
		...
		<tr> 
			...
			<td>{{$st->phone}}</td>
			<td>
				<a href="#" class="btn btn-primary edit_buttons" data-toggle="modal" data-pk="{{$st->id}}" data-target="#editModal"> Edit </a>
			</td>
			<td>
				<a href="#" class="btn btn-danger delete_link" data-toggle="modal" data-target="#deletdialog" data-rid="{{$st->id}}"> Delete </a>
			</td>
			<td>
				<a href="{{asset('students/detail').'/'.$st->id}}" class="btn btn-success"> View all info </a>
			</td>
		</tr>
		@endforeach
		@else
...
<script type="text/javascript">
	...
	{{-- Get and show user data via Ajax request --}}
	$.get({
